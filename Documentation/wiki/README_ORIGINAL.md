# Ingenium Framework Wiki

Complete wiki-style reference documentation for the Ingenium FiveM framework.

---

## 🚀 Getting Started with Public API

**NEW**: Comprehensive public API documentation is now available!

### For External Resource Developers

If you're building a script/resource that works **with** Ingenium, start here:

1. **[PUBLIC_API.md](PUBLIC_API.md)** - Complete guide to public exports and events
   - 62+ safe-to-use exports
   - 11+ public events
   - Code examples for common tasks
   - Best practices and error handling

2. **[EXPORTS_GUIDE.md](EXPORTS_GUIDE.md)** - Full reference of all exports by category
   - Organized by functionality
   - Parameter documentation
   - Usage examples
   - Quick reference table

3. **[EVENTS_REFERENCE.md](EVENTS_REFERENCE.md)** - Complete event documentation
   - Public events (safe to trigger)
   - Protected events (blocked from external use)
   - Event patterns and security
...
exports["ingenium"]:AddPolyZone({
    name = "myzone",
    points = {vector3(0,0,0), vector3(10,0,0)},
...
This wiki contains comprehensive documentation for **745 functions** and **100+ events** across the Ingenium framework. Each item has its own dedicated markdown file with:
...
1. **For External Scripts**: Start with [PUBLIC_API.md](PUBLIC_API.md)
2. **Browse by Namespace**: Find functions organized by their namespace (e.g., `ig.func`, `ig.callback`, `ig.appearance`)
3. **Click on a Function**: Each function name links to its dedicated documentation page
4. **Read Examples**: All functions include practical usage examples
5. **Check Security Notes**: Functions with security implications include clear warnings

## Quick Links

### Most Common Namespaces

- **[func](#func)** - 65 utility functions
- **[vehicle](#vehicle)** - 32 vehicle functions
- **[appearance](#appearance)** - 50 appearance/customization functions
- **[voip](#voip)** - 43 voice communication functions
- **[item](#item)** - 36 item system functions
- **[status](#status)** - 36 player status functions
- **[data](#data)** - 27 data management functions
- **[job](#job)** - 27 job system functions
- **[note](#note)** - 26 note system functions

### Important Resources

- 🔒 **[PUBLIC_API.md](PUBLIC_API.md)** - Public exports & events (start here!)
- 📋 **[EXPORTS_GUIDE.md](EXPORTS_GUIDE.md)** - All 62+ exports organized
- 📡 **[EVENTS_REFERENCE.md](EVENTS_REFERENCE.md)** - Event documentation
- 🛡️ **[Security Guide](../Security_Guide.md)** - Best practices

## Security Best Practices

⚠️ **Public API** (Safe for external resources):
- ✅ All exports with no GetInvokingResource() checks
- ✅ Public events (no security validation)
- ✅ Server callbacks with ticket validation
- 📖 See [PUBLIC_API.md](PUBLIC_API.md) for details

🔒 **Internal API** (Framework only):
- ❌ Protected events with GetInvokingResource() checks
- ❌ Internal server functions
- ❌ Database manipulation
- 📖 See [EVENTS_REFERENCE.md](EVENTS_REFERENCE.md) for protected events
...
**Total Functions**: 745+ | **Total Events**: 100+ | **Public Exports**: 62+ | **Public Events**: 11+
