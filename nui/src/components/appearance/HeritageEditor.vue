...
// Heritage dropdowns intentionally left blank - user must select values
// TODO: Add validation on save to ensure all 4 heritage values are set for freemode peds
