...
-- Player toggles HUD focus from NUI (e.g., pressing configured key while focused)
-- Sent from: nui/src/components/HUD.vue when the configured focus key is pressed in focus mode
