...
Citizen.CreateThread(function()
    Wait(5000)
    ig.debug.Info("========================================")
    ig.debug.Info("Vue 3 NUI Test Commands:")
    ig.debug.Warn("/test-notify - Test notifications")
    ig.debug.Warn("/test-menu - Test menu system")
    ig.debug.Warn("/test-input - Test input dialog")
    ig.debug.Warn("/test-context - Test context menu")
    ig.debug.Warn("/test-hud-show - Show HUD")
    ig.debug.Warn("/test-hud-hide - Hide HUD")
    ig.debug.Warn("/test-hud-update - Update HUD with current stats")
    ig.debug.Warn("/test-character-select - Test character select")
    ig.debug.Info("========================================")
end)
