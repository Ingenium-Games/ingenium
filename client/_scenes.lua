...
RegisterKeyMapping("+scenecreate", "(scenes): Place Scene", "keyboard", "F5")
RegisterKeyMapping("+scenehide", "(scenes): Toggle Scenes", "keyboard", "F6")
RegisterKeyMapping("+scenedelete", "(scenes): Delete Scene", "keyboard", "F7")
