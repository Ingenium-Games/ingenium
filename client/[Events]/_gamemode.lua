...
if conf.gamemode == "RP" then
    ...
    AddEventHandler("Client:EnteredVehicle", function(vehicle, seat, name, netId)
        ...
        c.func.Debug_3("RP Mode: Entered vehicle " .. name)
    ...
    AddEventHandler("Client:LeftVehicle", function(vehicle, seat, name, netId)
        ...
        c.func.Debug_3("RP Mode: Left vehicle " .. name)
...
if conf.gamemode == "DM" or conf.gamemode == "TDM" then
    ...
    AddEventHandler("Client:EnteredVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3(conf.gamemode .. " Mode: Entered vehicle " .. name)
    ...
    AddEventHandler("Client:LeftVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3(conf.gamemode .. " Mode: Left vehicle " .. name)
    end)
end
...
if conf.gamemode == "KOTH" then
    AddEventHandler("Client:EnteredVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("KOTH Mode: Entered vehicle " .. name)
        
        -- KOTH specific vehicle logic
    end)
    
    AddEventHandler("Client:LeftVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("KOTH Mode: Left vehicle " .. name)
    end)
end
...
if conf.gamemode == "FR" then
    AddEventHandler("Client:EnteredVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("FR Mode: Entered vehicle " .. name)
        
        -- Free roam vehicle logic (similar to RP but less restrictive)
    end)
    
    AddEventHandler("Client:LeftVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("FR Mode: Left vehicle " .. name)
    end)
end
...
if conf.gamemode == "GG" then
    AddEventHandler("Client:EnteredVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("GG Mode: Entered vehicle " .. name)
        
        -- Gun game typically disables vehicles or has special rules
    end)
    
    AddEventHandler("Client:LeftVehicle", function(vehicle, seat, name, netId)
        c.func.Debug_3("GG Mode: Left vehicle " .. name)
    end)
end
